...
from dataset_locs_changed_megha import get_dataset_locs
...
#         description="Parameters for " "preparing quantization"
#     )
...
#     parser.add_argument("--input_downsampling", type=int, default=2)
...
#     parser.add_argument("--aggregator_type", type=str, default="conv")
#     parser.add_argument("--vq_type", type=str, default="kmeans")
#     parser.add_argument("--vq_gamma", type=float, default=0.25)
#     parser.add_argument("--num_conv_agg_layers", type=int, default=2)
#     parser.add_argument("--num_steps_prediction", type=int, default=10)
#     parser.add_argument("--num_negatives", type=int, default=10)
#     parser.add_argument("--learning_rate", type=float, default=1e-3)
#     parser.add_argument("--weight_decay", type=float, default=0.0)
#     parser.add_argument("--node", type=str, default="glados")
#     parser.add_argument("--unnormalized", type=str, default="True")
#     parser.add_argument("--pre_exp_name", type=str, default="")
#     parser.add_argument(
#         "--saved_model_folder",
#         type=str,
#         default="/coc/pcba1/mthukral3/gt/lexicon-of-human-movements-main/saved_model_folder",
#     )
...
def perform_quantization(args):
    ...
    args.saved_model = os.path.join(
        args.saved_model_folder, model_save_name(args, capture="True") + ".pkl"
    )
...
def generate_quantized_data(args):
