...
def get_dataset_locs(args):
    ...
    if hostname == "zatopek":
        folder_name = "/coc/pcba1/hharesamudram3/capture_24/code"
    elif hostname == "assessment":
        folder_name = "//primary/capture-24/data"
    else:
        folder_name = "/coc/flash3/hharesamudram3/capture-24/code"
    ...
    if args.dataset == "capture_24":
        args.root_dir = os.path.join(
            folder_name,
            "data_preparation/capture_24/all_data/Dec-31-2021/capture_24_sr_50_users_100",
        )
    ...
    scaler = os.path.join(
        folder_name,
        "data_preparation/capture_24/all_data/"
        "Dec-31-2021/capture_24_sr_50_users_100",
        "scaler.joblib",
    )
    ...
    if args.dataset == "mobiact":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/mobiactv2/all_data/Oct-10-2021", unnormalized
        )
    ...
    if args.dataset == "motionsense":
        args.root_dir = os.path.join(
            folder_name,
            "data_preparation/motionsense/all_data/Oct-10-2021",
            unnormalized,
        )
    ...
    if args.dataset == "usc_had":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/usc_had/all_data/Nov-27-2021", unnormalized
        )
    ...
    if args.dataset == "hhar":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/hhar/all_data/Nov-24-2021", unnormalized
        )
        args.data_file = "hhar_watch_sr_50_fold_{}.joblib".format(fold)
        args.num_classes = 6
    if args.dataset == "myogym":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/myogym/all_data/Nov-24-2021", unnormalized
        )
        args.data_file = "myogym_3_sr_50_fold_{}.joblib".format(fold)
        args.num_classes = 31
    if args.dataset == "wetlab":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/wetlab/all_data/Nov-26-2021", unnormalized
        )
    ...
    if args.dataset == "pamap":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/pamap2/all_data/Nov-27-2021", unnormalized
        )
        args.data_file = "pamap2_3_sr_50_fold_{}.joblib".format(fold)
        args.num_classes = 12
    if args.dataset == "daphnet":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/daphnet/all_data/Nov-25-2021", unnormalized
        )
        args.data_file = "daphnet_sr_64_fold_{}.joblib".format(fold)
        args.num_classes = 3
    if args.dataset == "mhealth":
        args.root_dir = os.path.join(
            folder_name, "data_preparation/mhealth/all_data/Nov-25-2021", unnormalized
        )
